...
const Information = () => {
    ...
    if (loading) {
        return (
            <div className='fixed w-screen h-screen  z-1000 dark:bg-black  dark:text-white pt-[65px] px-[15%] '>
    ...
    return (
        <div
            className={` fixed w-screen h-screen bg-[#F0F2F5] dark:bg-black dark:text-white pt-[65px] px-[15%] rounded-lg `}>
            <div
                    ...
                    <div className='absolute h-[95%] w-[95%] flex items-center bg-[#F0F2F5] dark:bg-black  justify-center '>
                        {post.image && (
                            <img
                                src={post.image.url}
                                alt=''
                                className='w-full h-auto max-h-full object-contain  '></img>
                        )}
                    </div>
                </div>
